...
Use this when the user asks why a provider is missing, why a tool is unavailable, or how to connect WHOOP, Garmin, Oura, Strava, Fitbit, Withings, Apple Health, Polar, Nourish, or Exercise Catalog.
