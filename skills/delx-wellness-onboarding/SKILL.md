...
4. Ask which data sources they use: WHOOP, Garmin, Oura, Strava, Fitbit, Withings, Apple Health, Polar, Nourish, Exercise Catalog.
...
8. Summarize the profile and list the next connector setup commands or MCP status checks.
